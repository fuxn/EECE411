...
public class KVStore {
	...
	public static void main(String[] args) throws IOException {
		...
		nodes.add("planetlab2.bgu.ac.il");
		nodes.add("kupl2.ittc.ku.edu");
		nodes.add("planet-lab2.uba.ar");
		nodes.add("pl2.pku.edu.cn");
		...
		nodes.add("ple2.tu.koszalin.pl");
		nodes.add("planetlab1.sics.se");
		nodes.add("planetlab1.lkn.ei.tum.de");

		nodes.add("aguila2.lsi.upc.edu");
		nodes.add("aguila1.lsi.upc.edu");
		nodes.add("planetlab1.exp-math.uni-essen.de");
		nodes.add("planet1.l3s.uni-hannover.de");
		nodes.add("planetlab1.tmit.bme.hu");

		nodes.add("planetlab3.hiit.fi");
		nodes.add("planetlab2.cs.uit.no");
		*/
